...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Items.date_to_fix'
        db.alter_column('impl_tickets_items', 'date_to_fix', self.gf('django.db.models.fields.DateTimeField')(null='true'))

    def backwards(self, orm):

        # Changing field 'Items.date_to_fix'
        db.alter_column('impl_tickets_items', 'date_to_fix', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        'impl_tickets.items': {
            ...
            'date_to_fix': ('django.db.models.fields.DateTimeField', [], {'null': "'true'"}),
